...
1. Read `.engineering-os/config/models.md` to confirm the recommended model for each agent.
2. Inform the user: "This command uses **Architect** and **Tech Lead**. Check `.engineering-os/config/models.md` for recommended models and switch before continuing."
...
Save the plan to `docs/plan.md` using `.engineering-os/templates/plan.md` as the base structure.
